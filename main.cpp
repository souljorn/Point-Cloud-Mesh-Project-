...
void init()
{
	...
	for (int i = 0; i < normalsUnordered.size(); i++) {
		...
		std::cout << "," << std::endl;*/
		 ...
		 normalsUnordered.at(i).x = scale * normalsUnordered.at(i).x + centroidPoints.at(i).x;
		 normalsUnordered.at(i).y = scale * normalsUnordered.at(i).y + centroidPoints.at(i).y;
		 normalsUnordered.at(i).z = scale * normalsUnordered.at(i).z + centroidPoints.at(i).z;
	...
	for (int i = 0; i < normalOriented.size(); i++) {
		...
		normalOriented.at(i).x = scale * normalOriented.at(i).x + centroidPoints.at(i).x;
		normalOriented.at(i).y = scale * normalOriented.at(i).y + centroidPoints.at(i).y;
		normalOriented.at(i).z = scale * normalOriented.at(i).z + centroidPoints.at(i).z;
	}
